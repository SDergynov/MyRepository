...
public class Main extends JComponent implements KeyListener, ActionListener, MouseListener, MouseMotionListener {
    ...
    static final MonitorCord pointZero = new MonitorCord(512,400);
    ...
    private static double angleVisionAlfa=PI/4, angleVisionBeta=PI/3;
    private static ArrayList<AxesLines> axesLinesArrayList;
    ...
    public void axesXYZ(Graphics gr){
